...
INC_DIRS=-I./ -I$(GAME_PATH)/Ogre/OgreMain/include/ -I$(GAME_PATH)/Ogre/include/ -I$(GAME_PATH)/boost_1_57_0/ -I$(GAME_PATH)/tinyxml -I$(GAME_PATH)/OgreDeps/src/ois/includes -I$(GAME_PATH)/bass_2.4 -I$(GAME_PATH)
LIB_DIRS=-L./ -L$(GAME_PATH)/Ogre/lib/ -L$(GAME_PATH)/boost_1_57_0/stage/lib/ -L$(GAME_PATH)/tinyxml -L$(GAME_PATH)/OgreDeps/src/ois 
#-L$(GAME_PATH)/bass_2.4
LIBS=-lboost_system-mgw48-mt-1_57 -lOgreMain -ltinyxml -lOIS 
#-lbass
